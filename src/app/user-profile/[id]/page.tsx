    ...
    <>
      ...
      <main className="px-4">
        <div className="flex justify-between items-end mb-3">
          ...
          <div className="flex justify-around gap-5">
            <div className="flex flex-col text-center pt-3">
              <span className="font-bold">12</span> <span>Campaigns</span>
            </div>
            <div className="flex flex-col text-center pt-3">
              <span className="font-bold">628</span> <span>Followers</span>
            </div>
            <div className="flex flex-col text-center pt-3">
              <span className="font-bold"> 700</span> <span>Following</span>
            </div>
          </div>
        </div>
        <div className="flex flex-col">
          <h1 className="font-bold mb-2">Ashley Watson</h1>
        ...
        <FilterList
          ...
          itemData={mockPasses}
          filters={mockFilters}
          ItemComponent={({ data: pass }) => <UserProfileCard pass={pass} />}
        />
      </main>
    </>
  );
